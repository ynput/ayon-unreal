...
class ExtractLayout(publish.Extractor):
    ...
    def process(self, instance):
        ...
        for actor in actors:
            ...
            if mesh:
                ...
                repre_id = eal.get_metadata_tag(
                    asset_container, "representation"
                )
                ...
                json_element["transform_matrix"] = self.get_transform_matrix(
                    transform
                )
    ...
    def get_basis_matrix(self):
        ...
        basis_list = [
            [
                identity_matrix.x_plane.x,
                identity_matrix.x_plane.y,
                identity_matrix.x_plane.z,
                identity_matrix.x_plane.w,
            ],
            [
                identity_matrix.y_plane.x,
                identity_matrix.y_plane.y,
                identity_matrix.y_plane.z,
                identity_matrix.y_plane.w,
            ],
            [
                identity_matrix.z_plane.x,
                identity_matrix.z_plane.y,
                identity_matrix.z_plane.z,
                identity_matrix.z_plane.w,
            ],
            [
                identity_matrix.w_plane.x,
                identity_matrix.w_plane.y,
                identity_matrix.w_plane.z,
                identity_matrix.w_plane.w,
            ],
        ]
        return basis_list
    ...
    def get_transform_matrix(self, transform):
        ...
        transform = unreal.Transform(
            location=translation, rotation=rotation, scale=scale
        )
        transform_m_matrix = transform.to_matrix()
        transform_matrix = [
            [
                transform_m_matrix.x_plane.x,
                transform_m_matrix.x_plane.y,
                transform_m_matrix.x_plane.z,
                transform_m_matrix.x_plane.w,
            ],
            [
                transform_m_matrix.y_plane.x,
                transform_m_matrix.y_plane.y,
                transform_m_matrix.y_plane.z,
                transform_m_matrix.y_plane.w,
            ],
            [
                transform_m_matrix.z_plane.x,
                transform_m_matrix.z_plane.y,
                transform_m_matrix.z_plane.z,
                transform_m_matrix.z_plane.w,
            ],
            [
                transform_m_matrix.w_plane.x,
                transform_m_matrix.w_plane.y,
                transform_m_matrix.w_plane.z,
                transform_m_matrix.w_plane.w,
            ],
        ]

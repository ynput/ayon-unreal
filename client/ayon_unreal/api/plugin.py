...
class LayoutLoader(Loader):
    ...
    def _load_assets(self, project_name, instance_name,
                     repre_id, product_type, repr_format, options):
        ...
        res_priority = options.get("resolution_priority", "project_first")
        assets = self.get_existing_asset(project_name, repre_id,
    ...
    def get_existing_asset(self, project_name, repre_id,
                           resolution_priority):
